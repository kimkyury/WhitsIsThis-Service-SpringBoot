...
class odom(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(TurtlebotStatus,'/turtlebot_status',self.listener_callback,30)
        self.imu_sub = self.create_subscription(Imu,'/imu',self.imu_callback,30)
        ...
        self.x=-5.825535774230
        self.y=6.400105430053
    ...
    def scan_callback(self,msg):
        self.x=msg.range_min
        self.y=msg.scan_time
