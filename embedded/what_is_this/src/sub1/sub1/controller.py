...
class Controller(Node):
    ...
    def timer_callback(self):
        ...
        가전 제품 : 가전상태 출력        
        '''
        print('current_linear vel : {0} , current_angular_vel : {1} , battery : {2} , supply_status : {3}'.format(self.cmd_msg.linear.x,self.cmd_msg.angular.z,self.turtlebot_status_msg.battery_percentage,self.turtlebot_status_msg.power_supply_status))
        ## IOT(가전) 제어 함수
        # self.app_all_on()
        # self.app_all_off()
